...
function load_type_menu {
    while true; do
        ...
        case $type_choice in
            1) echo "Применение настроек для коротких соединений...";;  # Тут должна быть реализация изменения настроек
            2) echo "Применение настроек для длительных соединений...";;  # Тут должна быть реализация изменения настроек
            3) echo "Применение стандартных настроек BBR...";;  # Тут должна быть реализация изменения настроек
            4) return ;;
